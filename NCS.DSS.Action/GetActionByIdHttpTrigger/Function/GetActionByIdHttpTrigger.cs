...
namespace NCS.DSS.Action.GetActionByIdHttpTrigger.Function
{
    public class GetActionByIdHttpTrigger
    {
        ...
        {
            _logger.LogTrace("Function {FunctionName} has been invoked", nameof(GetActionByIdHttpTrigger));
            ...
            _logger.LogTrace("Successfully retrieved Action for Customer. Action ID: {ActionId}. Customer GUID: {CustomerGuid}", action.ActionId.GetValueOrDefault(), customerGuid);
            _logger.LogTrace("Function {FunctionName} has finished invoking", nameof(GetActionByIdHttpTrigger));
