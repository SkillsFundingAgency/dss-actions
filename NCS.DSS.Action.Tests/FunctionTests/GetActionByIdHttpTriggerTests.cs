...
namespace NCS.DSS.Action.Tests.FunctionTests
{
    ...
    public class GetActionByIdHttpTriggerTests
    {
        ...
        private Mock<ILogger<GetActionByIdHttpTrigger.Function.GetActionByIdHttpTrigger>> _logger;
        ...
        public void Setup()
        {
            ...
            _logger = new Mock<ILogger<GetActionByIdHttpTrigger.Function.GetActionByIdHttpTrigger>>();
        ...
        public async Task GetActionsByIdHttpTrigger_ReturnsStatusCodeNoContent_WhenInteractionDoesNotExist()
        {
            ...
            _resourceHelper.Setup(x => x.DoesInteractionExistAndBelongToCustomer(_interactionId, _customerId)).Returns(Task.FromResult(false));
        ...
        public async Task GetActionsByIdHttpTrigger_ReturnsStatusCodeOk_WhenActionExists()
        {
            ...
            _httpRequestHelper.Setup(x => x.GetDssTouchpointId(_request)).Returns("0000000001");
            _resourceHelper.Setup(x => x.DoesCustomerExist(It.IsAny<Guid>())).Returns(Task.FromResult(true));
            _getActionByIdHttpTriggerService.Setup(x => x.GetActionForCustomerAsync(It.IsAny<Guid>(), It.IsAny<Guid>(), It.IsAny<Guid>())).Returns(Task.FromResult(_action));
